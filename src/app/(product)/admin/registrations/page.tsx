...
export default async function RegistrationQueue() {
  ...
  return (
    <div className="site-container space-y-6 py-8">
      ...
      <p className="text-body-sm text-text-muted">{communityAccessMode() === "public" ? "Public registration is enabled. Eligible pending users already have member access. Approval retains access when switching to private mode; rejection denies access in both modes." : "Private registration is enabled. Pending users require administrator approval."}</p>
