...
export async function findPublicProfile(
  ...
  const [profile] = await database
    .select({
      ...
      vouchPositive: profiles.vouchPositive,
      vouchNeutral: profiles.vouchNeutral,
      vouchNegative: profiles.vouchNegative,
      threadCount: profiles.threadCount,
      postCount: profiles.postCount,
      likeCount: profiles.likeCount,
      creditBalance: profiles.creditBalance,
